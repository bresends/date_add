...
export default class Dia {
  ...
  constructor(date: Date | null = null, lang: string = 'default') {
    ...
    this.mesNumero = Number(
      date.toLocaleDateString(lang, { month: '2-digit' })
    );
   ...
   */
  format(stringFormato: string): string {
